...
function getTile(tile, j, i) {
  ...
  const tileMap = {
    ...
    'Eq': [aT, 6], 'Ew': [aT+1, 6], 'Ee': [aT+2, 6],
    'Ea': [aT, 7], 'Es': [aT+1, 7], 'Ed': [aT+2, 7],
    'Ez': [aT, 8], 'Ex': [aT+1, 8], 'Ec': [aT+2, 8],
    'Bq': [aT, 9], 'Bw': [aT+1, 9], 'Be': [aT+2, 9],
    'Ba': [aT,10], 'Bs': [aT+1,10], 'Bd': [aT+2,10],
    'Bz': [aT,11], 'Bx': [aT+1,11], 'Bc': [aT+2,11]
  };
  if (tile in tileMap) {
